      ...
      children: [
        buildParagraph(
          'Welcome to Qars Spin. Protecting your privacy, we handle your personal information with care. '
              'This privacy policy describes how we collect, share, and use information when you visit or make a purchase from our website or mobile app.',
        ),
        ...
        buildParagraph(
          'You are regularly communicating with others using the messenger, which includes sending various types of data that we collect to provide better Services.\n\n'
              ...
              'Device Information: We may collect information about the device you use when accessing our Services, including network type, hardware, operating system, and unique identifiers.',
        ),

        const SizedBox(height: 20),
        buildTitle('2. How We Use Your Information'),
        buildParagraph(
        ...
        const SizedBox(height: 20),
        buildTitle('3. Sharing Your Information'),
        buildParagraph(
          'We may share your information with the following parties:\n\n'
              ...
              '• Corporate Transactions: If Qars Spin undergoes a merger, acquisition, or sale, your data may be transferred as part of that transaction.',
        ),

        const SizedBox(height: 20),
        buildTitle('4. Your Choices and Rights'),
        buildParagraph(
          'You have the following rights regarding your information:\n\n'
              ...
              '• Cookies: Manage cookie preferences through browser settings or our Cookie Policy.',
        ),

        const SizedBox(height: 20),
        buildTitle('5. Security'),
        buildParagraph(
          'We implement various measures to protect your data from unauthorized access or misuse. However, no online transmission or storage method is 100% secure, and we cannot guarantee absolute security.',
        ),

        const SizedBox(height: 20),
        buildTitle('6. Children\'s Privacy'),
        buildParagraph(
          'Our Services are not directed at individuals under 18. We do not knowingly collect personal information from minors. If such data is found, we delete it immediately.',
        ),

        const SizedBox(height: 20),
        buildTitle('7. International Data Transfers'),
        buildParagraph(
          'Your information may be stored or processed in other countries with different data protection laws. By using our Services, you consent to such transfers.',
        ),

        const SizedBox(height: 20),
        buildTitle('8. Changes to This Privacy Policy'),
        buildParagraph(
          'We may update this Privacy Policy occasionally. Changes will be posted on our website and mobile app. Please review periodically for updates.',
        ),
        ...
        buildParagraph(
          'If you have any questions about this Privacy Policy or our practices, contact us:\n\n'
              ...
              'This privacy policy ensures that Qars Spin is transparent about how user data is handled, providing peace of mind to customers while complying with legal requirements.',
        ),
      ],
    );
  }
