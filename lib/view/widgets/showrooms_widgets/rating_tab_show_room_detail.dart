    ...
    return GetBuilder<ShowRoomsController>(
        ...
        return ListView(
          ...
          children: [
            ...
            Center(child: Text("${controller.partnerRating.total}",style: TextStyle(fontSize: 15.sp,color:AppColors.black,fontWeight: FontWeight.w600,fontFamily: fontFamily), )),
           10.verticalSpace,
            Padding(
             ...
             child: Row(
               children: [
                 ...
                 Text("Out of 5",style: TextStyle(fontSize: width*.033 ,fontWeight: FontWeight.bold)),
